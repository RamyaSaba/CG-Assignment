...
void display(){
     ...
     glColor3f(1.0,1.0,1.0);
     glRasterPos3f(-0.30,-0.4,-1.0);
     text("UNDER THE GUIDANCE OF");
     glColor3f(1.0,0.0,0.0);
     glRasterPos3f(-0.30,-0.5,-1.0);
     text("Prof. MUNESHWARA M S");
     glColor3f(1.0,1.0,1.0);
     glRasterPos3f(-0.30,-0.6,-1.0);
     text("Asst. Prof., Dept of CS&E");
     glRasterPos3f(-0.30,-0.7,-1.0);
     text("BMS INSTITUTE OF TECHNOLOGY");
